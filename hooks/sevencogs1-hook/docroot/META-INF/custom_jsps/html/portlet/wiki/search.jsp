...
<aui:form action="<%= searchURL %>" method="get" name="fm">
	...
	try {
		...
		for (int i = 0; i < results.getDocs().length; i++) {
			...
			long curPageId = GetterUtil.getLong(doc.get(Field.ENTRY_CLASS_PK));
			...
			try {
				curPage = WikiPageLocalServiceUtil.getPage(curPageId);
			...
			row.addText(dateFormatDateTime.format(curPage.getCreateDate()), rowURL);

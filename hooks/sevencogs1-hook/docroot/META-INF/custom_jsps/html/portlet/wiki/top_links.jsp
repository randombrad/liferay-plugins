							...
							<div class="field-inline">
								<div class="field-content">
									<div class="tab-unit f">
										<label class="field-label" for="<portlet:namespace />keywords">Search</label>
									</div>

									<div class="tab-unit l">
										<input class="aui-field-input aui-field-input-text" type="text" title="<liferay-ui:message key="search-messages" />" name="<portlet:namespace />keywords" id="<portlet:namespace />keywords" value="<%= HtmlUtil.escape(keywords) %>" />
									</div>
								</div>
							</div>
						</div>
